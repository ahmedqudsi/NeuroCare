...
export const sampleHospitals: Hospital[] = [
  {
    ...
    address: 'Opp. Nanal Nagar, Mehdipatnam, Hyderabad, Telangana 500028, India',
  ...
  },
  {
    ...
    address: 'No 6-3-347/22/A, Dwarakapuri,Near Saibaba Temple, Punjagutta, Hyderabad, Telangana 500082, India',
